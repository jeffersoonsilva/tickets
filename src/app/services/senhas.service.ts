...
export class SenhasService {
  ...
  chamarSenha() {
    ...
    const senhaPrioritaria = this.senhasEmitidas.find(senha => senha.numero.startsWith('SP'));
    if (senhaPrioritaria) {
    ...
    const senhaExame = this.senhasEmitidas.find(senha => senha.numero.startsWith('SE'));
    if (senhaExame) {
  ...
  criarSenhaPrioritaria(): void {
    const senhaPrioritaria: Senha = this.criarSenha('SP');
  ...
  criarSenhaGeral(): void {
    const senhaGeral: Senha = this.criarSenha('SG');
  ...
  criarSenhaExame(): void {
    const senhaExame: Senha = this.criarSenha('SE');
